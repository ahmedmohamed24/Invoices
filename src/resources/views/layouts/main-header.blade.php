                    ...
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown"
                            ...
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="{{ asset('assets/img/world.svg') }}" alt=""></span>
                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            <a href="{{ LaravelLocalization::getLocalizedURL('en') }}" class="dropdown-item d-flex ">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><i
                                        class="flag-icon flag-icon-us flag-icon-squared"></i></span>
                                <div class="d-flex">
                ...
                <div class="dropdown nav-item main-header-notification">
                    ...
                    <div class="dropdown-menu">
                        <div class="menu-header-content bg-primary text-right">
                            <div class="d-flex">
                                <h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">{{ __('main-sidebar.notifications') }}</h6>
                                <button class="badge badge-pill badge-warning mr-auto my-auto float-left border-0" onclick="markAllAsRead()">{{ __('main-sidebar.Mark all as read') }}</button>
                            </div>
                            <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">{{ __('main-sidebar.You have') }} {{ Auth::user()->unreadNotifications->count() }} {{ __('main-sidebar.unread Notifications') }}</p>
                        </div>
                        <div class="main-notification-list Notification-scroll">
                            @if (count($notifications) === 0)
                                <p class="text-center text-primary py-2">{{ __('main-sidebar.No notifications yet') }}</p>
                            @else
                                @foreach ($notifications as $notification)
                                    <a class="d-flex p-3 border-bottom" href="{{ route('notifications.read',$notification->id) }}">
                                        <div class="notifyimg bg-pink d-flex justify-content-center align-items-center">
                                            <i class="la la-file-alt text-white"></i>
                                        </div>
                                        <div class="mr-3">
                                            @if ($notification->read_at === null)
                                                <h5 class="notification-label mb-1">
                                                    {{ json_decode($notification->data)->Description }}
                                                </h5>
                                            @else
                                                <h5 class="notification-label mb-1 text-muted">
                                                    {{ json_decode($notification->data)->Description }}
                                                </h5>
                                            @endif
                        ...
                        <div class="dropdown-footer">
                            ...
                            <a href="{{ route('notifications.all') }}">{{ __('main-sidebar.VIEW ALL') }}</a>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('profile.settings') }}"><i
                                class="bx bx-slider-alt"></i>{{ __('main.account settings') }} </a>
