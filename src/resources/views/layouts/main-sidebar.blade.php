<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">{{ __("main-sidebar.project name") }}</li>
					<li class="slide">
                    ...
                    {{-- invoices --}}
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ __("main-sidebar.ivnoices") }}</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.all invoices") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.paid invoices") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.partially paid") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.not paid") }}</a></li>
						</ul>
                    </li>

                    {{-- reports --}}
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ __("main-sidebar.reports") }}</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.invoices reports") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.users reports") }}</a></li>
						</ul>
                    </li>

                    {{-- users --}}
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ __("main-sidebar.all users") }}</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.all users") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.users permissions") }}</a></li>
						</ul>
					</li>
                    {{-- settings --}}
                   <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">{{ __("main-sidebar.settings") }}</span><i class="angle fe fe-chevron-down"></i></a>
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.add department") }}</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='home') }}">{{ __("main-sidebar.add product") }}</a></li>
						</ul>
                    </li>
                    {{-- end my content --}}
					<li class="slide">
