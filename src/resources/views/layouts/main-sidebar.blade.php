			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('invoice.all')}}">{{ __("main-sidebar.all invoices") }}</a></li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('report.index') }}">{{ __("main-sidebar.invoices reports") }}</a></li>
							<li><a class="slide-item" href="{{ route('report.main') }}">{{ __("main-sidebar.users reports") }}</a></li>
						</ul>
                    </li>
                    ...
                    <li class="slide">
                        ...
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('user.index') }}">{{ __("main-sidebar.all users") }}</a></li>
							<li><a class="slide-item" href="{{ route('permission.index') }}">{{ __("main-sidebar.users permissions") }}</a></li>
							<li><a class="slide-item" href="{{ route('role.index') }}">{{ __("main-sidebar.users roles") }}</a></li>
						</ul>
					</li>
                    {{-- settings --}}
                   <li class="slide">
                        ...
                        <ul class="slide-menu">
							<li><a class="slide-item" href="{{ route('department.index') }}">{{ __("settings.departments") }}</a></li>
							<li><a class="slide-item" href="{{ route('product.index') }}">{{ __("product.products") }}</a></li>
						</ul>
                    </li>
                    {{-- end my content --}}
					{{-- <li class="slide">
