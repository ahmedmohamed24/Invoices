                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('invoice.store') }}" enctype="multipart/form-data" method="POST"
                        ...
                        <div class="row row-xs formgroup-wrapper mt-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.invoice number') }}</label> <input
                                        class="form-control" placeholder="EX:1999" type="text"
                                        value="{{ old('invoiceNumber') }}" name="invoiceNumber">
                                </div><!-- main-form-group -->
                            </div>
                            {{-- invoice date --}}
                            <div class="col-md-4 ">
                                ...
                                <div class="row row-sm mg-b-20 ">
                                    <div class="input-group">
                                        ...
                                        </div><input class="form-control fc-datepicker" value="{{ old('invoiceDate') }}"
                                            id="datetimepicker2" name="invoiceDate" placeholder="MM/DD/YYYY" type="text">
                                    </div>
                                </div>
                            </div>
                            {{-- invoice due date --}}
                            <div class="col-md-4 ">
                                ...
                                <div class="row row-sm mg-b-20 ">
                                    <div class="input-group">
                                        ...
                                        </div><input class="form-control fc-datepicker" id="datetimepicker22"
                                            name="invoiceDueDate" placeholder="MM/DD/YYYY" type="text"
                                            value="{{ old('invoiceDueDate') }}">
                                    </div>
                                </div>
                            </div>
                            {{-- department --}}
                            <div class="col-lg-4 ">
                                <p class="mg-b-10">{{ __('invoice.Department') }}</p><select name="department"
                                    onchange="getProducts(this.value)" onfocusout="getProducts(this.value)" id="departments"
                            ...
                            {{-- prodcuts --}}
                            <div class="col-lg-4 ">
                                <p class="mg-b-10">{{ __('invoice.product') }}</p><select name="product" id="prodcuts"
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="mg-b-10 form-label">{{ __('invoice.paid amount') }}</label> <input
                                        id="paidAmount" class="form-control" type="text"
                                        value="{{ old('paidAmount') ?? 0 }}" onchange="claculateCommisionAmount()"
                                        onfocusout="claculateCommisionAmount()" onchange="claculateCommisionAmount()"
                                        name="paidAmount">
                                </div>
                                <small class="alert alert-danger d-none"
                                    id="paidAmountError">{{ __('invoice.paid amount error') }}</small>
                            </div>
                            {{-- Commision percent--}}
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.commision percent') }}</label> <input
                                        class="form-control" type="text" onfocusout="claculateCommisionAmount()"
                                        onchange="claculateCommisionAmount()" onchange="claculateCommisionAmount()"
                                        value="{{ old('commisionPercent') ?? 0 }}" name="commisionPercent"
                                        id="commisionPercent">
                                </div>
                                <small class="alert alert-danger d-none"
                                    id="comissionError">{{ __('invoice.commision percent error') }}</small>
                            </div>
                            {{-- commision Amount --}}
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.commision amount') }}</label> <input
                                        class="form-control" type="text" value="{{ old('commisionAmount') ?? 0 }}"
                                        name="commisionAmount" readonly id="commisionAmount">
                                </div>
                            </div>
                            {{-- deduction--}}
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.deduction') }}</label> <input
                                        class="form-control" type="text" value="{{ old('deductionAmount') ?? 0 }}"
                                        onfocusout="changeDeductionAmount()" onchange="changeDeductionAmount()"
                                        name="deductionAmount" id="deductionAmount">
                                </div>
                                <small class="alert alert-danger d-none"
                                    id='deductionError'>{{ __('invoice.deduction amount error') }}</small>
                            </div>
                            {{-- vat percent--}}
                            <div class="col-lg-4 col-md-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    </div><input onchange="calculateVatValue()" onfocusout="calculateVatValue()"
                                        class="form-control" type="text" value="{{ old('vatRate') ?? 0 }}" name="vatRate"
                                        id="vatRate">
                                </div>
                                <small class="alert alert-danger d-none"
                                    id="vatRateError">{{ __('invoice.vat rate error') }}</small>
                            </div>
                            {{-- vat value --}}
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.vat value') }}</label> <input
                                        class="form-control" readonly type="text" value="{{ old('vatValue') ?? 0 }}"
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="form-label">{{ __('invoice.total') }}</label> <input class="form-control "
                                        readonly type="text" value="{{ old('totalAmount') ?? 0 }}" name="totalAmount"
                                        id="totalAmount">
                                </div><!-- main-form-group -->
                            </div>
                            {{-- notes --}}
                            <div class="col-12">
                                ...
                                <div class="">
                                    <textarea class="form-control" placeholder="Write your notes here ..." name="notes"
                                        cols="auto" id="notes" rows="5">{{ old('notes') }}</textarea>
                                </div>
                            </div>
                            {{-- Attachments --}}
                            <div class="col-12">
                                ...
                                <div class="col-12 ">
                                    <input type="file" class="dropify" data-height="200" id="attachments" name="attachments"
                                        multiple />
                                </div>
                            </div>
                            {{-- submit buttons --}}
                            <div class="d-flex  align-items-center col-md-6 mt-2">
                                <div class="ml-2">
                                    <button id="submitBtn" class="btn px-5 btn-success btn-block " type="submit"
                                        disabled>{{ __('invoice.create') }}</button>
                                </div>
                                <div class=" ">
...
@section('js')
    ...
    <script>
        ...
        function calculateTotalAmount() {
            totalAmount.value = (parseFloat(vatValue.value) + parseFloat(commisionAmount.value) - parseFloat(deductionAmount
                .value));
